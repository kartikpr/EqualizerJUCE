...
private:
    audioFilter lowShelfL;
    audioFilter highShelfL;
    audioFilter lowPassL;
    audioFilter highPassL;
    audioFilter peakL;
    audioFilter lowShelfR;
    audioFilter highShelfR;
    audioFilter lowPassR;
    audioFilter highPassR;
    audioFilter peakR;
    juce::AudioParameterFloat* knobLowShelf;
    juce::AudioParameterFloat* lowShelfGain;
    juce::AudioParameterFloat* knobHighShelf;
